...
- `crypter_cooldowns.py` - shared linkcrypter cooldown state machine; validates canonical protected-crypter keys, atomically records independent evidence, and exposes read-only availability snapshots
